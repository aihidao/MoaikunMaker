...
const translations_jaJP = {
    ...
    'forbiddenPleaceEnemyWarning': '敵の上限に達しました。これ以上敵を配置できません',
    ...
    'forbiddenPleaceConsecutiveMoaiWarning': 'システムの制限により、14個以上の連続したモアイNPCを配置することはできません。そうしないと、圧縮されたデータがマップの終わりを示すことになります。',
